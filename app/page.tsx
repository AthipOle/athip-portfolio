...
const copy = {
  th: {
    ...
    target: "กำลังมองหาโอกาสสหกิจในตำแหน่ง Software Tester Intern",
    intro:
      "นักศึกษาสาขาวิทยาการคอมพิวเตอร์ที่สนใจด้าน Software Testing และ Quality Assurance มีประสบการณ์จากโปรเจกต์มหาวิทยาลัยทั้งด้านการพัฒนาเว็บแอปพลิเคชัน การเชื่อมต่อ API การจัดการฐานข้อมูล และการทดสอบระบบ พร้อมเรียนรู้กระบวนการทดสอบซอฟต์แวร์จากการทำงานจริง",
    ...
    aboutBody:
      "ผมสนใจด้าน Software Testing และ Quality Assurance โดยให้ความสำคัญกับการตรวจสอบการทำงานของระบบ การค้นหาและวิเคราะห์ข้อผิดพลาด รวมถึงการทดสอบฟังก์ชันต่าง ๆ ให้เป็นไปตามความต้องการของผู้ใช้งาน เป้าหมายของผมคือพัฒนาทักษะด้าน Software Testing จากการทำงานจริง และเติบโตเป็น Software Tester ที่สามารถช่วยให้ซอฟต์แวร์มีคุณภาพและใช้งานได้อย่างมีประสิทธิภาพ",
    ...
    awardResult:
      "ผลงานได้รับรางวัลจากการประยุกต์ใช้ AI เพื่อช่วยให้ผู้ใช้งานมองเห็นภาพห้องก่อนตัดสินใจตกแต่ง สะท้อนประสบการณ์ด้านการทำงานเป็นทีม การทดสอบและแก้ไขข้อผิดพลาดของระบบ การพัฒนาซอฟต์แวร์ และการนำเสนอผลงาน",
    contactLabel: "CONTACT",
    contactTitle: "มาร่วมสร้างซอฟต์แวร์ที่มีคุณภาพไปด้วยกัน",
    contactBody:
      "ผมกำลังมองหาโอกาสสหกิจในตำแหน่ง Software Tester Intern และพร้อมเรียนรู้กระบวนการทดสอบซอฟต์แวร์ รวมถึงทำงานร่วมกับทีมเพื่อช่วยพัฒนาซอฟต์แวร์ให้มีคุณภาพและตอบโจทย์ผู้ใช้งาน",
    email: "อีเมล",
    phone: "โทรศัพท์",
  ...
  en: {
    ...
    role: "Software Tester",
    target: "Seeking a Software Tester Co-op Internship",
    intro:
      "A Computer Science student interested in Software Testing and Quality Assurance, with project experience in web application development, API integration, database management, and system testing. I am eager to develop my software testing skills through real-world projects.",
    ...
    aboutBody:
      "I am interested in Software Testing and Quality Assurance, with a focus on checking system functionality, identifying and analyzing defects, and testing features against user requirements. My goal is to gain practical software testing experience and grow into a Software Tester who can help deliver reliable and high-quality software.",
    ...
    awardResult:
      "The project received this award for applying AI to a real interior-design decision problem. The experience strengthened my teamwork, software testing, debugging, software development, and presentation skills.",
    contactLabel: "CONTACT",
    contactTitle: "Let’s build better software together",
    contactBody:
      "I am currently seeking a Software Tester Co-op Internship and am ready to learn software testing processes and contribute to a real software development team to help deliver reliable and high-quality software.",
    email: "Email",
    phone: "Phone",
...
const certificates = [
  ...
  },
  {
    id: "03",
    titleTh:
      "พื้นฐานปัญญาประดิษฐ์บน Oracle Cloud Infrastructure ประจำปี 2025",
    titleEn:
      ...
      <header className="site-header">
        <a className="brand" href="#home" aria-label="Athip portfolio home">
          ...
          <span>
            ...
            <small>Software Tester Intern</small>
          </span>
        </a>
      ...
      <section className="quick-stats">
        <div className="section-shell stats-grid">
          ...
          <div className="status-card">
            <span className="pulse-dot" />
            <strong>SOFTWARE TESTER CO-OP 2027</strong>
          </div>
        </div>
      </section>
